...
import { selectTeacherForm, selectTeacherFormCurrentIndex, updateAddTeacherForm, updateFormIndex } from '../../store/reducers/addTeacherSlice';
...
const AddTeacher: React.FC = () => {
  ...
  // const formData = useAppSelector((state) => state.addStudentForm)
  // const formIndex = useAppSelector((state) => state.currentFormIndex)
  const formData = useSelector(selectTeacherForm)
  const formIndex = useSelector(selectTeacherFormCurrentIndex) 
  ...
  const handleInputChange = (ele: ADDSTUDENTFORM, value: string) => {
    ...
    dispatch(updateAddTeacherForm({ele, value}))
